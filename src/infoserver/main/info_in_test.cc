...
void build_input(TipcSrv &t, input *i, int query)
{
  ...
  while(elem = i->current())
  {
	...
	cin >> q_int;
	cin.ignore(10000,'\n');
	msg << q_int /*sergey << Check*/;
      }
      else
      {
	msg << int_val /*sergey << Check*/;
	int_val++;
      }
      break;
    case t_floating:
	...
	cin >> q_flt;
	cin.ignore(10000,'\n');
	msg << q_flt /*sergey << Check*/;
      }
      else
      {
	msg << flt_val /*sergey << Check*/;
	flt_val += 1.0;
      }
      break;
    case t_tagged:
	...
	cin >> buf;
	cin.ignore(10000,'\n');
	msg << buf /*sergey << Check*/;
	if (!strcmp("Skip",buf))
	  break;
      }
      else
      {
	msg << ((tagged *)elem)->tagname() /*sergey << Check*/;
      }
    }
    case t_array:
    {
	...
	if (query)
	{
	  ...
	  msg << SetSize(5) << q_i_ary /*sergey << Check*/;
	}
	else
	{
	  msg << SetSize(10) << inta /*sergey << Check*/;
	}
	break;
      case arr_float:
	cout << " Floats" << endl;
	if (query)
	{
	  ...
	  msg << SetSize(5) << q_f_ary /*sergey << Check*/;
	}
	else
	{
	  msg << SetSize(10) << floata /*sergey << Check*/;
	}
	break;
      default:
	break;
