...
#define MAXSHIFT 8 /* maximum deviation in segment between layer 0 and layer 6 */ 
...
void SegmentSearch3(word112_t axial[6], word112_t out[NOFFSETS]);
ap_uint<1> RegionSearch1(word112_t in1[6], word112_t in2[6], word112_t out[NOFFSETS]);
