...
void
ftofhitfanout(hls::stream<FTOFHit> &s_hit, hls::stream<FTOFHit> &s_hit1, hls::stream<FTOFHit> &s_hit2, volatile ap_uint<1> &hit_scaler_inc)
{
...
#pragma HLS PIPELINE II=1
  ...
  if(fifo.output != 0) hit_scaler_inc = 1;
