...
void
pcuhiteventwriter(hls::stream<trig_t> &trig_stream, hls::stream<eventdata3_t> &event_stream, event_ram_t buf_ram_read[2048])
{
...
//#pragma HLS ARRAY_PARTITION variable=buf_ram_read block factor=4
  ...
  while(addr != stop_addr)
  {
...
#ifdef DEBUG
	std::cout<<"pcuhiteventwriter: buf_ram_val.output="<<buf_ram_val.output<<endl;
#endif
    ...
    if(buf_ram_val.output != 0)
	{
      ...
      eventdata.data[0](30,27)  = PCUHIT_TAG;
      eventdata.data[0](26,16)  = addr - start_addr;  /*8 bits*/
      eventdata.data[0](15,6)   = 0;
      eventdata.data[0](5,0)    = buf_ram_val.output(67,62); /*6 bits*/
      //event_stream.write(eventdata);
#ifdef DEBUG
	  std::cout<<"pcuhiteventwriter: write1="<<eventdata.data<<endl;
#endif
      ...
      //event_stream.write(eventdata);
#ifdef DEBUG
	  std::cout<<"pcuhiteventwriter: write2="<<eventdata.data<<endl;
#endif
      ...
      event_stream.write(eventdata);
#ifdef DEBUG
	  std::cout<<"pcuhiteventwriter: write3="<<eventdata.data<<endl;
#endif
	}
