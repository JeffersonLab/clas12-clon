...
void cnd(ap_uint<16> threshold[3], nframe_t nframes, hls::stream<fadc_256ch_t> &s_fadcs, hls::stream<CNDHit_8slices> &s_hits, volatile ap_uint<1> &hit_scaler_inc, hit_ram_t buf_ram[512]);
...
void cndhitfanout(CNDHit s_hit[NH_READS], hls::stream<CNDHit_8slices> &s_hits, CNDHit s_hit2[NH_READS], volatile ap_uint<1> &hit_scaler_inc);
