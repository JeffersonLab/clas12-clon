...
System.out.println("Alarm 4");
		...
		audioMenuItem1 = new java.awt.MenuItem("Disable Beep (Permanently)");
		audioMenu.add(audioMenuItem1);

		audioMenuItem2 = new java.awt.MenuItem("Enable Beep");
		audioMenu.add(audioMenuItem2);
...
System.out.println("Alarm 5");
		...
		audioMenuItem1.addActionListener(lSymAction);
		audioMenuItem2.addActionListener(lSymAction);
        ...
        for(int i=0; i<errorVector.size(); i++){
                ...
                if(!((MyErrorClass)errorVector.elementAt(i)).ack){
                   try{
                        ...
                        if( (beep) && (beeper.beepState) && (!beeper.beepSilence)) {
...
//Sergey            alarmLabel2.setVisible(false);
	...
	//=============================================================
	//   This method stops the beeping forever
	//=============================================================
	public void beepSilence(){

	    beeper.beepSilence = true;
	    setStatus1("IMPORTANT: Beeping Turned Off forever !!!");
	}

	//=============================================================
	//   This method starts the beeping
	//=============================================================
	public void beepStart(){

	    beeper.beepSilence = false;
	    setStatus1("Beeping Turned On");
	}
	...
	java.awt.MenuItem audioMenuItem1;
	java.awt.MenuItem audioMenuItem2;
	//}}
		...
		public void actionPerformed(java.awt.event.ActionEvent event)
		{
			...
			Object object = event.getSource();
			 if (object == defaultMenuItem){
			  ...
			  beepStop();
			  else if(object == audioMenuItem1)
			  beepSilence();
			  else if(object == audioMenuItem2)
			  beepStart();
